...
public class JCloudsCloudTest {
    ...
    public void testConfigurationUI() throws Exception {
        JCloudsCloud cloud = new JCloudsCloud("aws-profile", "aws-ec2", "tenantId", "", "", "http://localhost", 1,
    ...
    public void testConfigRoundtrip() throws Exception {
        ...
        JCloudsCloud original = new JCloudsCloud("aws-profile", "aws-ec2", "tenantId", "", "", "http://localhost", 1,
                CloudInstanceDefaults.DEFAULT_INSTANCE_RETENTION_TIME_IN_MINUTES, 600 * 1000, 600 * 1000, null,
                "foobar", true, Collections.<JCloudsSlaveTemplate> emptyList());
