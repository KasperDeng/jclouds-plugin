...
public class JCloudsCloudInsideJenkinsLiveTest {
    ...
    public void setUp() throws Exception {
        ...
        cloud = new JCloudsCloud(fixture.getProvider() + "-profile", fixture.getProvider(), fixture.getCredentialsId(),
                fixture.getTenantId(), null, fixture.getEndpoint(), 1,
                CloudInstanceDefaults.DEFAULT_INSTANCE_RETENTION_TIME_IN_MINUTES, 600 * 1000, 600 * 1000, null,
    ...
    public void testDoTestConnectionCorrectCredentialsEtc() throws IOException {
        FormValidation result = new JCloudsCloud.DescriptorImpl().doTestConnection(fixture.getProvider(),
                fixture.getCredentialsId(), generatedKeys.get("private"), fixture.getEndpoint(), null, true);
