...
public class TerminateNodesTest {
    ...
    public void testSuspendOnlySuspendsNodesInQuestion() throws InterruptedException, ExecutionException, RunNodesException {
        ...
        if (null != compute) {
            ...
            Iterable<RunningNode> runningNodesToSuspend = Iterables.transform(split.get(0),
                    new Function<NodeMetadata, RunningNode>() {

                        public RunningNode apply(NodeMetadata input) {
                            return new RunningNode("stub", "template", true, InstancePostAction.SUSPEND_SLAVE_JOB_DONE,
                                    input);
                        }
    ...
    public void testDestroyOnlyDestroysNodesInQuestion() throws InterruptedException, ExecutionException, RunNodesException {
        ...
        if (null != compute) {
            ...
            Iterable<RunningNode> runningNodesToDestroy = Iterables.transform(split.get(0),
                    new Function<NodeMetadata, RunningNode>() {

                        public RunningNode apply(NodeMetadata input) {
                            return new RunningNode("stub", "template", false, InstancePostAction.SUSPEND_SLAVE_JOB_DONE,
                                    input);
                        }
    ...
    public void testSuspendAndDestroy() throws InterruptedException, ExecutionException, RunNodesException {
        ...
        if (null != compute) {
            ...
            Iterable<RunningNode> runningNodesToDestroy = Iterables.transform(split.get(1),
                    new Function<NodeMetadata, RunningNode>() {
